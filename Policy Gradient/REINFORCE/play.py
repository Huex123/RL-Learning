...
def save_gif(gifs):
    ...
    anim.save("REINFORCE_play_CartPole.gif", writer='pillow', fps=30)
...
if __name__ == '__main__':
    ...
    agent.policy_net.load_state_dict(torch.load('CartPole_REINFORCE_policy_net1.pt'))
    ...
    axes.set_title("REINFORCE_play_rewards")
    axes.set_xlabel("episode")
    axes.set_ylabel("episode reward")
    fig.savefig('REINFORCE_play_rewards.png')

    print('REINFORCE playing ended successfully!')
    env.close()
