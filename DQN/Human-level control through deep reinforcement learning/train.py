...
if __name__ == '__main__':
    ...
    is_win = False
    # tensorboard
    summary_writer = SummaryWriter(log_dir = "train_DQN_stackframe", comment= "good_makeatari")
    ...
    # 保存神经网络模型
    # torch.save(agent.Qnet.state_dict(), 'Pong_Qnet.pt')
    '''
    ...
    df_rewards.to_csv('DQN_train_rewards.csv')
    '''
    再次打开：
    data = pd.read_csv('DQN_train_rewards.csv')
    '''
    print('DQN training ended successfully!')
